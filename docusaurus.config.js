    ...
    [
      ...
      ({
        ...
        blog: {
          ...
          routeBasePath: 'news',
          // Eight posts per page: four rows of the two-column card grid, and
          // the page stays scrollable. Every card carries the post's whole
          // summary, so more cards would make the page very long.
          postsPerPage: 8,
